...
namespace {
    ...
    long poissoninput_binomial_19(const int vectorisation_idx)
    {
        long X = 0;
...
void _run_poissoninput_19_codeobject()
{
...
const size_t _num_sub_idx = 1;
    ...
    int32_t*   _ptr_array_default_neurons_subgroup_19__sub_idx_1 = _array_default_neurons_subgroup_19__sub_idx_1;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const int32_t _sub_idx = _ptr_array_default_neurons_subgroup_19__sub_idx_1[_idx];
        ...
        if(not_refractory)
            v += _lio_1 * poissoninput_binomial_19(_vectorisation_idx);
    ...
    poissoninput_19_codeobject_profiling_info += _run_time;
}
