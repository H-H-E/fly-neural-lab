...
namespace {
    ...
    long poissoninput_binomial_7(const int vectorisation_idx)
    {
        long X = 0;
...
const size_t _num_sub_idx = 1;
    ...
    int32_t*   _ptr_array_default_neurons_subgroup_7__sub_idx_1 = _array_default_neurons_subgroup_7__sub_idx_1;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const int32_t _sub_idx = _ptr_array_default_neurons_subgroup_7__sub_idx_1[_idx];
        ...
        if(not_refractory)
            v += _lio_1 * poissoninput_binomial_7(_vectorisation_idx);
    ...
    poissoninput_7_codeobject_profiling_info += _run_time;
}
