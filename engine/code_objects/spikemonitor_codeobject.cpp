...
const size_t _num_source_i = 138639;
const int64_t _source_start = 0;
const int64_t _source_stop = 138639;
const size_t _num_source_t = 1;
const size_t _num_spikespace = 138640;
const size_t _numcount = 138639;
...
const size_t _num_source_idx = 138639;
    ///// POINTERS ////////////
        
    int32_t*   _ptr_array_spikemonitor_N = _array_spikemonitor_N;
    double*   _ptr_array_defaultclock_t = _array_defaultclock_t;
    int32_t* __restrict  _ptr_array_default_neurons_i = _array_default_neurons_i;
    ...
    int32_t _num_events = _ptr_array_default_neurons__spikespace[_num_spikespace-1];
    ...
    if (_num_events > 0)
    {
        ...
        {
            const int _idx = _ptr_array_default_neurons__spikespace[_j];
        ...
        if (_num_events > 0) {
            ...
            {
                const size_t _idx = _ptr_array_default_neurons__spikespace[_j];
                const size_t _vectorisation_idx = _idx;
                                
                const int32_t _source_i = _ptr_array_default_neurons_i[_idx];
