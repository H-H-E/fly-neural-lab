...
void _run_poissoninput_13_codeobject()
{
...
const size_t _num_sub_idx = 1;
    ...
    int32_t*   _ptr_array_default_neurons_subgroup_13__sub_idx_1 = _array_default_neurons_subgroup_13__sub_idx_1;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const int32_t _sub_idx = _ptr_array_default_neurons_subgroup_13__sub_idx_1[_idx];
    ...
    poissoninput_13_codeobject_profiling_info += _run_time;
}
