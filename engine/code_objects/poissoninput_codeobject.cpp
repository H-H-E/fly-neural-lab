...
namespace {
    ...
    long poissoninput_binomial(const int vectorisation_idx)
    {
        long X = 0;
...
const size_t _num_sub_idx = 1;
    ...
    int32_t*   _ptr_array_default_neurons_subgroup__sub_idx = _array_default_neurons_subgroup__sub_idx;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const int32_t _sub_idx = _ptr_array_default_neurons_subgroup__sub_idx[_idx];
        ...
        if(not_refractory)
            v += _lio_1 * poissoninput_binomial(_vectorisation_idx);
    ...
    poissoninput_codeobject_profiling_info += _run_time;
}
