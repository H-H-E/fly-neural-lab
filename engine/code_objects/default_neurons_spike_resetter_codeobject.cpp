...
const double v_rst = - 0.052000000000000005;
const size_t _numnot_refractory = 138639;
	...
	const int32_t *_events = _ptr_array_default_neurons__spikespace;
	const int32_t _num_events = _ptr_array_default_neurons__spikespace[N];
 ...
 const int64_t w = 0;
    ...
    default_neurons_spike_resetter_codeobject_profiling_info += _run_time;
}
