...
void _run_default_synapses_pre_push_spikes()
{
...
const size_t _numdelay = _dynamic_array_default_synapses_delay.size();
    ...
    {
        default_synapses_pre.advance();
        default_synapses_pre.push(_ptr_array_default_neurons__spikespace, _ptr_array_default_neurons__spikespace[_num_spikespace-1]);
    }
    ...
    default_synapses_pre_push_spikes_profiling_info += _run_time;
}
